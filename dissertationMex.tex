...
\begin{abstract}[flattitle]
  ...
  物联网\gls{iot}的快速发展是人们的生产生活变得更加便捷。

\end{abstract}

\begin{abstract*}[flattitle]
 
  This is the abstract of this paper. I would like to introduce the main research object, the method used, and the results.

  The rapid growth of the \gls{iot} has made our lives more convenient and our production more efficient. However, the power solution for billions of \gls{iot} devices could be more optimal, as the writed power supply is complex, and battery replacement requires much labor.
...
%         校徽文件inFigFolder \texttt{shanghaitech-emblem.pdf} 缺失%
%       \end{minipage}%
%     }%
%   }%
...
\begin{figure}[htb]
  \centering
  \IfFileExists{fig/shanghaitech-emblem.pdf}{%
    \includegraphics[width=0.5\columnwidth]{fig/shanghaitech-emblem.pdf}%
  }{%
    \fbox{%
      \begin{minipage}[b][2.5cm][c]{0.75\columnwidth}%
        \centering\zihao{-5}\bfseries\sffamily\color{ShtRed}%
        校徽文件 in ./fig 文件夹 \texttt{shanghaitech-emblem.pdf} 缺失%
      \end{minipage}%
    }%
  }%
  \bicaption{上海科技大学校徽}{School logo of ShanghaiTech University}
...
\begin{figure}[htb]
  ...
  \IfFileExists{fig/gaosq.jpg}{%
    \includegraphics[width=0.5\columnwidth]{fig/gaosq.jpg}%
  }{%
    \fbox{%
      \begin{minipage}[b][2.5cm][c]{0.75\columnwidth}%
        \centering\zihao{-5}\bfseries\sffamily\color{ShtRed}%
